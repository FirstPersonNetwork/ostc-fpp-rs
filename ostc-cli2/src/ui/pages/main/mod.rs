...
use ostc::colors::{COLOR_BORDER, COLOR_SUCCESS, COLOR_TEXT_DEFAULT};
use ratatui::{
    Frame,
    layout::{
        Alignment,
...
/// MainPage handles the UI and the state of the primary ostc interface
pub struct MainPage {
    /// Action sender
