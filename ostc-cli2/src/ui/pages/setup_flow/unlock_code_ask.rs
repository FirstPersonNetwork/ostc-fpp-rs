...
use ostc::colors::{COLOR_BORDER, COLOR_DARK_GRAY, COLOR_SUCCESS, COLOR_TEXT_DEFAULT};
use ratatui::{
    Frame,
    layout::{
...
impl UnlockCodeAsk {
    ...
    pub fn render(&self, state: &SetupState, frame: &mut Frame) {
        ...
        let mut lines = vec![
            Line::styled(
                "An unlock code encrypts your cryptographic keys, configuration, and private data stored by OSTC.",
        ...
        if let UnlockCodeAsk::UseCode = self {
            ...
            lines.push(Line::styled(
                "    Anyone with access to this device will be able to open OSTC and use your keys and access your private data.",
