...
use ostc::colors::{COLOR_BORDER, COLOR_DARK_GRAY, COLOR_TEXT_DEFAULT};
use ratatui::{
    Frame,
    layout::{
...
impl TokenStart {
    ...
    pub fn render(&self, state: &SetupState, frame: &mut Frame) {
        ...
        let lines = vec![
            Line::styled(
                "For enhanced security, you can protect your OSTC profile with a hardware token. This step is recommended but optional.",
