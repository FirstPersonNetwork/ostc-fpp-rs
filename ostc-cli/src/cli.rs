...
pub fn cli() -> Command {
    ...
    Command::new("pgp-keys").args([
            ...
            Command::new("settings").args([
                ...
                Arg::new("file").short('f').long("file").help("File to save settings to").default_value("export.ostc"),
            ]).about("Exports settings which can be imported into another ostc installation")
        ])
    ...
    let tasks_subcommand = Command::new("tasks")
        ...
        .subcommand(
            Command::new("clear").about("Clears tasks").args([
                ...
                Arg::new("remote")
                    .long("remote")
                    .help("Will also clear remote messages on OSTC Task Queue")
                    .default_value("false")
                    .action(ArgAction::SetTrue),
            ]),
        )
    ...
    Command::new("ostc")
        ...
        .subcommand(Command::new("status").about("Displays status of the ostc tool"))
        .subcommand(
            Command::new("setup")
                .about("Initial configuration of the ostc tool")
                .subcommand(
                    Command::new("import").about("Import settings").args([
                        Arg::new("file")
                            .short('f')
                            .long("file")
                            .default_value("export.ostc")
