# LKMV Config Data Structure

The LKMV tool stores configuration data in three main categories:
...
When calling the LKMV tool commands, it loads the three
...
Logs track key events in the LKMV tool from initial setup to establishing
...
- **Config**: "Initial lkmv setup completed"
- **Contact**: "Added contact (did:webvh:...lkmv4) alias(John Doe)"
- **Relationship**: "Relationship requested: remote
  DID(did:webvh:...lkmv4) Task ID(5be058b3-...)"
- **Task**: "Fetched: Task ID(5be058b3-...) Type(Relationship
  Request (Inbound)) From(did:webvh:...lkmv1)"
...
logs: Logs {
    messages: [
        ...
        LogMessage {
            ...
            type_: Config,
            message: "Initial lkmv setup completed",
        },
        // Contact added
        LogMessage {
            created: 2026-01-12T06:05:00.345729Z,
            type_: Contact,
            message: "Added contact (did:webvh:...lkmv4) alias(John Doe)",
        },
        // Relationship requested
        LogMessage {
            created: 2026-01-12T06:05:00.361997Z,
            type_: Relationship,
            message: "Relationship requested: remote DID(...lkmv4) Task ID(5be058b3-...)",
        },
        // Request finalized
        LogMessage {
            created: 2026-01-12T06:06:08.646416Z,
            type_: Relationship,
            message: "Relationship request finalized: remote DID(...lkmv4) Task ID(5be058b3-...)",
        },
        // Task fetched
        LogMessage {
            ...
            message: "Fetched: Task ID(5be058b3-...)
                Type(Relationship Request Accepted) From(...lkmv4)",
        },
    ],
    limit: 100,
}
...
The LKMV tool uses `Mutex<T>` wrappers for mutable shared data, such as
Relationships and Tasks. This ensures data is protected during concurrent
operations or interactions with the LKMV tool.
...
The LKMV tool maintains consistency between related data structures, for example:
